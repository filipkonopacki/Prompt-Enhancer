...
def generate(prompt, max_new_tokens=200, num_beams=4):
    ...
    config = GenerationConfig(temperature=1.4, do_sample=True, top_k=50, top_p=0.95, num_return_sequences=4)
...
if __name__ == "__main__":
    output = generate('Enhance this image generation prompt:\nA cat sitting in the chair', max_new_tokens=200, num_beams=4, )
    print(output)
